...
// scan the name column with getText ->Beans->print the price of the Rice
        ...
        price = rows.stream().filter(s -> s.getText().contains("Rice"))
                ...
                .map(s -> getPriceVeggie(driver, s)).collect(Collectors.toList());
    ...
    private static String getPriceVeggie(WebDriver driver, WebElement s) {

// TODO Auto-generated method stub


        String pricevalue = driver.findElement(with(By.tagName("td")).toRightOf(s)).getText();
